    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Kelola jadwal kelas renang
                        </p>
                    </div>
                    <div className="flex gap-3">
                        <Link href="/management-jadwal/create">
                            <Button>
                    ...
                    <CardContent className="p-4">
                        <div className="flex flex-col sm:flex-row gap-4">
                            <div className="relative flex-1">
                                ...
                                <Input
                                    placeholder="Cari kelas atau lokasi..."
                                    className="pl-10"
                                    value={searchQuery}
                                            ...
                                            <TableRow key={schedule.id}>
                                                <TableCell>
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <p className="font-medium">{schedule.class_session?.title}</p>
                                                            <p className="text-xs text-muted-foreground">
                                                                {schedule.class_session?.course?.title}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </TableCell>
                                                ...
                                                <TableCell>
                                                    <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${statusDisplay.className}`}>
                                                        {statusDisplay.icon}
                                                        {statusDisplay.label}
                                                    </span>
                                                </TableCell>
                                                <TableCell className="text-right">
                                                    <div className="flex justify-end gap-1">
                                                        <Link href={`/management-jadwal/${schedule.id}`}>
                                                        ...
                                                        <AlertDelete
                                                            ...
                                                            action={() => handleDelete(schedule.id)}
                                                        />
                                                    </div>
                                                </TableCell>
                                            </TableRow>
                ...
                {/* Pagination */}
                {props.schedules.last_page > 1 && (
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4">
                        <p className="text-sm text-muted-foreground order-2 sm:order-1">
                            Menampilkan {props.schedules.from} - {props.schedules.to} dari {props.schedules.total} jadwal
                        </p>
                            ...
                            <PaginationContent className="flex-wrap justify-center gap-1">
                                <PaginationItem>
                                    <PaginationPrevious
                                        ...
                                        className={!props.schedules.prev_page_url ? 'pointer-events-none opacity-50' : ''}
                                    />
                                </PaginationItem>
                                <PaginationItem>
                                ...
                                <PaginationItem>
                                    <PaginationNext
                                        ...
                                        className={!props.schedules.next_page_url ? 'pointer-events-none opacity-50' : ''}
                                    />
                                </PaginationItem>
                            </PaginationContent>
                        </Pagination>
